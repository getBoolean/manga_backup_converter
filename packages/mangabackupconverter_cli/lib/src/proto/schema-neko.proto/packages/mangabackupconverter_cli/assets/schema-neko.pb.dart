...
//  source: packages/mangabackupconverter_cli/assets/schema-neko.proto
//
// @dart = 2.12
...
class BackupChapter extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(800)
  set pagesLeft($core.int v) { $_setSignedInt32(10, v); }
  @$pb.TagNumber(800)
...
class BackupManga extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BackupManga', createEmptyInstance: create)
    ...
    ..aOS(901, _omitFieldNames ? '' : 'scanlatorFilter', protoName: 'scanlatorFilter')
    ..aOS(903, _omitFieldNames ? '' : 'alternativeArtwork', protoName: 'alternativeArtwork')
    ..pc<BackupMergeManga>(904, _omitFieldNames ? '' : 'mergeMangaList', $pb.PbFieldType.PM, protoName: 'mergeMangaList', subBuilder: BackupMergeManga.create)
  ;
  ...
  @$pb.TagNumber(800)
  set customTitle($core.String v) { $_setString(19, v); }
  @$pb.TagNumber(800)
  ...
  @$pb.TagNumber(901)
  set scanlatorFilter($core.String v) { $_setString(20, v); }
  @$pb.TagNumber(901)
  ...
  @$pb.TagNumber(903)
  set alternativeArtwork($core.String v) { $_setString(21, v); }
  @$pb.TagNumber(903)
...
class BackupMergeManga extends $pb.GeneratedMessage {
  ...
  factory BackupMergeManga.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BackupMergeManga.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BackupMergeManga', createEmptyInstance: create)
    ..aQS(1, _omitFieldNames ? '' : 'url')
    ..aOS(2, _omitFieldNames ? '' : 'title')
    ..aOS(3, _omitFieldNames ? '' : 'coverUrl', protoName: 'coverUrl')
    ..a<$core.int>(4, _omitFieldNames ? '' : 'mergeType', $pb.PbFieldType.Q3, protoName: 'mergeType')
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BackupMergeManga copyWith(void Function(BackupMergeManga) updates) => super.copyWith((message) => updates(message as BackupMergeManga)) as BackupMergeManga;
  ...
  static $pb.PbList<BackupMergeManga> createRepeated() => $pb.PbList<BackupMergeManga>();
  @$core.pragma('dart2js:noInline')
  static BackupMergeManga getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BackupMergeManga>(create);
  ...
  @$pb.TagNumber(4)
  set mergeType($core.int v) { $_setSignedInt32(3, v); }
  @$pb.TagNumber(4)
