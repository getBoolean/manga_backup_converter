...
//  source: packages/mangabackupconverter_cli/assets/schema-yokai.proto
//
// @dart = 2.12
...
import 'schema-yokai.pbenum.dart';

export 'schema-yokai.pbenum.dart';
...
class BackupCategory extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BackupCategory', createEmptyInstance: create)
    ...
    ..a<$core.int>(800, _omitFieldNames ? '' : 'mangaSort', $pb.PbFieldType.O3, protoName: 'mangaSort')
  ;
  ...
  @$pb.TagNumber(800)
  set mangaSort($core.int v) { $_setSignedInt32(3, v); }
  @$pb.TagNumber(800)
  $core.bool hasMangaSort() => $_has(3);
  @$pb.TagNumber(800)
  void clearMangaSort() => clearField(800);
}
...
class BackupManga extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(108)
  $core.List<$core.String> get excludedScanlators => $_getList(20);

  @$pb.TagNumber(602)
  $core.int get customStatus => $_getIZ(21);
  @$pb.TagNumber(602)
  set customStatus($core.int v) { $_setSignedInt32(21, v); }
  @$pb.TagNumber(602)
  $core.bool hasCustomStatus() => $_has(21);
  @$pb.TagNumber(602)
  void clearCustomStatus() => clearField(602);

  @$pb.TagNumber(800)
  $core.String get customTitle => $_getSZ(22);
  @$pb.TagNumber(800)
  set customTitle($core.String v) { $_setString(22, v); }
  @$pb.TagNumber(800)
  $core.bool hasCustomTitle() => $_has(22);
  @$pb.TagNumber(800)
  void clearCustomTitle() => clearField(800);

  @$pb.TagNumber(801)
  $core.String get customArtist => $_getSZ(23);
  @$pb.TagNumber(801)
  set customArtist($core.String v) { $_setString(23, v); }
  @$pb.TagNumber(801)
  $core.bool hasCustomArtist() => $_has(23);
  @$pb.TagNumber(801)
  void clearCustomArtist() => clearField(801);

  @$pb.TagNumber(802)
  $core.String get customAuthor => $_getSZ(24);
  @$pb.TagNumber(802)
  set customAuthor($core.String v) { $_setString(24, v); }
  @$pb.TagNumber(802)
  $core.bool hasCustomAuthor() => $_has(24);
  @$pb.TagNumber(802)
  void clearCustomAuthor() => clearField(802);

  @$pb.TagNumber(804)
  $core.String get customDescription => $_getSZ(25);
  @$pb.TagNumber(804)
  set customDescription($core.String v) { $_setString(25, v); }
  @$pb.TagNumber(804)
  $core.bool hasCustomDescription() => $_has(25);
  @$pb.TagNumber(804)
  void clearCustomDescription() => clearField(804);

  @$pb.TagNumber(805)
  $core.List<$core.String> get customGenre => $_getList(26);
}
