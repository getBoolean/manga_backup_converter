...
final $typed_data.Uint8List backupDescriptor = $convert.base64Decode(
    ...
    'YmFja3VwRXh0ZW5zaW9uUmVwbxJFChNiYWNrdXBTYXZlZFNlYXJjaGVzGNgEIAMoCzISLkJhY2'
    't1cFNhdmVkU2VhcmNoUhNiYWNrdXBTYXZlZFNlYXJjaGVz');
...
final $typed_data.Uint8List backupFlatMetadataDescriptor = $convert.base64Decode(
    'ChJCYWNrdXBGbGF0TWV0YWRhdGESPQoOc2VhcmNoTWV0YWRhdGEYASACKAsyFS5CYWNrdXBTZW'
...
const BackupManga$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.BackupFlatMetadata',
      '10': 'flatMetadata'
    },
    {'1': 'customStatus', '3': 602, '4': 1, '5': 5, '10': 'customStatus'},
    {
      '1': 'customThumbnailUrl',
      '3': 603,
      '4': 1,
      '5': 9,
      '10': 'customThumbnailUrl'
    },
...
final $typed_data.Uint8List backupMangaDescriptor = $convert.base64Decode(
    ...
    'Npb24SUgoVbWVyZ2VkTWFuZ2FSZWZlcmVuY2VzGNgEIAMoCzIbLkJhY2t1cE1lcmdlZE1hbmdh'
    'UmVmZXJlbmNlUhVtZXJnZWRNYW5nYVJlZmVyZW5jZXMSOAoMZmxhdE1ldGFkYXRhGNkEIAEoCz'
    'ITLkJhY2t1cEZsYXRNZXRhZGF0YVIMZmxhdE1ldGFkYXRhEiMKDGN1c3RvbVN0YXR1cxjaBCAB'
    'KAVSDGN1c3RvbVN0YXR1cxIvChJjdXN0b21UaHVtYm5haWxVcmwY2wQgASgJUhJjdXN0b21UaH'
    'VtYm5haWxVcmwSIQoLY3VzdG9tVGl0bGUYoAYgASgJUgtjdXN0b21UaXRsZRIjCgxjdXN0b21B'
    'cnRpc3QYoQYgASgJUgxjdXN0b21BcnRpc3QSIwoMY3VzdG9tQXV0aG9yGKIGIAEoCVIMY3VzdG'
    '9tQXV0aG9yEi0KEWN1c3RvbURlc2NyaXB0aW9uGKQGIAEoCVIRY3VzdG9tRGVzY3JpcHRpb24S'
    'IQoLY3VzdG9tR2VucmUYpQYgAygJUgtjdXN0b21HZW5yZQ==');
...
final $typed_data.Uint8List backupMergedMangaReferenceDescriptor = $convert.base64Decode(
    'ChpCYWNrdXBNZXJnZWRNYW5nYVJlZmVyZW5jZRIgCgtpc0luZm9NYW5nYRgBIAIoCFILaXNJbm'
...
final $typed_data.Uint8List backupSavedSearchDescriptor = $convert.base64Decode(
    'ChFCYWNrdXBTYXZlZFNlYXJjaBISCgRuYW1lGAEgAigJUgRuYW1lEhQKBXF1ZXJ5GAIgASgJUg'
...
final $typed_data.Uint8List backupSearchMetadataDescriptor = $convert.base64Decode(
    'ChRCYWNrdXBTZWFyY2hNZXRhZGF0YRIaCgh1cGxvYWRlchgBIAEoCVIIdXBsb2FkZXISFAoFZX'
...
final $typed_data.Uint8List backupSearchTagDescriptor = $convert.base64Decode(
    'Cg9CYWNrdXBTZWFyY2hUYWcSHAoJbmFtZXNwYWNlGAEgASgJUgluYW1lc3BhY2USEgoEbmFtZR'
...
final $typed_data.Uint8List backupSearchTitleDescriptor = $convert.base64Decode(
    'ChFCYWNrdXBTZWFyY2hUaXRsZRIUCgV0aXRsZRgBIAIoCVIFdGl0bGUSEgoEdHlwZRgCIAIoBV'
    'IEdHlwZQ==');
